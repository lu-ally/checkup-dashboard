...
export function T0Summary({ assessments }: T0SummaryProps) {
  if (assessments.length === 0) {
    return (
      <div className="bg-white p-6 rounded-lg shadow text-center text-gray-500">
        Keine T0-Daten vorhanden
      </div>
    )
  }
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            <p className="text-2xl font-bold text-blue-600">{wellbeingAvg.toFixed(1)}</p>
            <p className="text-xs text-gray-500">Wohlbefinden</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-blue-600">{workAreaAvg.toFixed(1)}</p>
            <p className="text-xs text-gray-500">Arbeit</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-blue-600">{privateAreaAvg.toFixed(1)}</p>
